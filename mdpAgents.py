...
class MDPAgent(Agent):
    ...
    @return
    """
    def __update_utilities(self, walls, neighbors, rewards, utilities, discount_factor=1.0, convergence_tolerance=0.0001, ignoring_walls=False, maximum_mode=True):
    ...
    def getAction(self, state, debug_mode=False, deep_debug_mode=False):
        ...
        """value iteration"""
        self.__value_iteration(state, debug_mode=debug_mode, deep_debug_mode=deep_debug_mode, ghostbuster_mode=self.__GHOSTBUSTER_MODE)
